...
export default function CoachingLinesLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${inter.className} min-h-screen bg-[#071426] font-sans text-[#f8fafc]`}>
      <header className="border-b border-[rgba(148,163,184,0.18)] px-4 py-3 sm:px-6 sm:py-4">
      ...
      <footer className="border-t border-[rgba(148,163,184,0.18)] px-4 py-6 sm:px-6 sm:py-8">
        <div className="mx-auto flex max-w-5xl flex-col gap-3 text-sm text-[#94a3b8] sm:flex-row sm:items-center sm:justify-between">
